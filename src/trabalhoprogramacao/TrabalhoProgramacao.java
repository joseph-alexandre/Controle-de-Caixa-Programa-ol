...
public class TrabalhoProgramacao {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Bem-vindo(a) a lanchonete do Zé.");
        //Variáveis
        double custo = 0;
        double custoTotalDia = 0;
       //Botões
        String[] items = {"Pizzas", "Salgados", "Doces", "Bebidas", "Sair"};
        int escolha = JOptionPane.showOptionDialog(null, "Temos um cardápio que consiste em: ", "Cardápio - Lanchonete do Zé", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, items, items[0]);
        while(escolha != 4){
                switch(escolha){
                    //Botão "Pizza"
                    case 0: 
                            ...
                            switch(pizzaPequena){
                                case 1:{
                                    ...
                                    if (finalizarCalabresa == JOptionPane.YES_OPTION){
                                            custo += 14.75;
                                            JOptionPane.showMessageDialog(null, "Você comprou uma Pizza de Calabresa!");
                                ...
                                case 2:{
                                    ...
                                    if (finalizarPepperoni == JOptionPane.YES_OPTION){
                                            custo += 16.50;
                                            JOptionPane.showMessageDialog(null, "Você comprou uma Pizza de Pepperoni!");
                                ...
                                case 3:{
                                     ...
                                     "Você deseja comprar Pizza à moda da casa do Seu Zé??","", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
                                    if (finalizarModa == JOptionPane.YES_OPTION){
                                            custo += 17.99;
                                            JOptionPane.showMessageDialog(null, "Você comprou uma Pizza à moda da casa do Seu Zé!");
                                ...
                                case 4: {
                                    ...
                                    if (finalizarMussarela == JOptionPane.YES_OPTION){
                                            custo += 14.75;
                                            JOptionPane.showMessageDialog(null, "Você comprou uma Pizza de Mussarela!");
